...
![desktop-view](https://res.cloudinary.com/diudkwkuw/image/upload/v1667462060/docs/desktop.png)![mobile-view-portrait](https://res.cloudinary.com/diudkwkuw/image/upload/v1667462059/docs/phone.png)![mobile-view-landscape](https://res.cloudinary.com/diudkwkuw/image/upload/v1667463305/docs/landscape_phone.png)
...
*   Reviews, with key information such as location, growing method
...
14.  As an admin user, I can view messages which have been sent from the contact-us form.
...
17.  As a logged-in Admin, I can delete an existing product or incoming message.
...
such as user\_type,  
location, profile\_image and reset\_password\_token. To generate access token, it inherits from baselayer.baseauthentication which has custom  
JWT authentication  
...
![desktop-view](https://res.cloudinary.com/diudkwkuw/image/upload/v1667462059/docs/schema.jpg)

### Color Palette

![color-palette](https://res.cloudinary.com/diudkwkuw/image/upload/v1667462059/docs/palette.png)
...
![login-toogle](https://res.cloudinary.com/diudkwkuw/image/upload/v1667462059/docs/login.png)![mymushaccount-logout-toogle](https://res.cloudinary.com/diudkwkuw/image/upload/v1667462059/docs/mymushaccount_logout.png)
...
![navbar-portrait](https://res.cloudinary.com/diudkwkuw/image/upload/v1667467130/docs/navbar_portrait.png)![navbar-landscape](https://res.cloudinary.com/diudkwkuw/image/upload/v1667467129/docs/navbar_landscape.png)
...
![navbar-landscape](https://res.cloudinary.com/diudkwkuw/image/upload/v1667467627/docs/carousel_desktop.png)
...
![reviews-dashboard](https://res.cloudinary.com/diudkwkuw/image/upload/v1667468791/docs/review_dashboard.png)
...
![footer-user](https://res.cloudinary.com/diudkwkuw/image/upload/v1667471646/docs/footer_user.png)![footer-admin](https://res.cloudinary.com/diudkwkuw/image/upload/v1667471646/docs/footer_admin.png)
...
![forgotpassword-page](https://res.cloudinary.com/diudkwkuw/image/upload/v1667474249/docs/forgot_password_page.png)
...
![emailverification-page](https://res.cloudinary.com/diudkwkuw/image/upload/v1667474249/docs/email_verification_page.png)

### Reset Token Email

**Reset Token**: An email with a link for the user to reset token will be send to the user's inbox.

![resettoken-email](https://res.cloudinary.com/diudkwkuw/image/upload/v1667475612/docs/reset_token_email.png)
...
![emailverification-page](https://res.cloudinary.com/diudkwkuw/image/upload/v1667475612/docs/change_password_page.png)

### Who Are We Page

![whoarewe-page](https://res.cloudinary.com/diudkwkuw/image/upload/v1667476814/docs/who_are_we.png)

### Know Your Mushrooms Page

![knowyourmushrooms-page](https://res.cloudinary.com/diudkwkuw/image/upload/v1667476814/docs/know_your_mushrooms.png)

### Mush!Forum Page

![mushforum-page](https://res.cloudinary.com/diudkwkuw/image/upload/v1667476813/docs/forum.png)
...
*   [Pexels](https://www.pexels.com/)
    *   Used to get the best free stock images.
...
![w3c-html-validation](https://res.cloudinary.com/diudkwkuw/image/upload/v1667482254/docs/html_validator_results.png)

*   [W3C CSS Validation Service](https://jigsaw.w3.org/css-validator/#validate_by_input)
    *   Used to validate all CSS code written and used in this webpage.

![w3c-css-validation](https://res.cloudinary.com/diudkwkuw/image/upload/v1667482254/docs/css_validator_results.png)
...
*   In the Settings tab, click on `Reveal Config Vars` and set the following variables:
    *   SECRET\_KEY - to be set to your chosen key
    *   CLOUDINARY\_URL - to be set to your Cloudinary API environment variable
